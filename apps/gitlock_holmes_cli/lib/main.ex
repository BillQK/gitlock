defmodule GitlockHolmesCLI.Main do
  @moduledoc """
  Command-line interface for GitlockHolmes code forensics tool.

  This module provides a user-friendly interface to the forensic code analysis 
  capabilities of GitlockHolmes, allowing developers to analyze their codebase
  ...
  defp run_investigation(options, remaining_args) do
    ...
    if investigation_type do
      ...
      if investigation_type in GitlockHolmesCore.available_investigations() do
        ...
        case GitlockHolmesCore.investigate(investigation_type, repo_source, options_map) do
          {:ok, result} ->
  ...
  defp display_help([]) do
    IO.puts("""
    GitlockHolmes v#{@version} - Forensic Code Analysis Tool

    Usage: 
      gitlock_holmes [investigation] [options]
      gitlock_holmes --investigation TYPE [options]  (Legacy style)
    ...
    Examples:
      gitlock_holmes hotspots --repo ./my_project --dir ./my_project
      gitlock_holmes knowledge-silos --repo ./git_log.txt
      gitlock_holmes blast-radius --repo ./my_project --target-files lib/core.ex --dir ./my_project
      
      # Legacy style
      gitlock_holmes --investigation hotspots --log ./git_log.txt --vcs git

    Use 'gitlock_holmes --help [investigation]' for information about a specific investigation.
    """)
  end
  ...
  defp display_help([investigation | _]) do
    case investigation do
      ...
      "knowledge_silos" ->
        IO.puts("""
        GitlockHolmes - Knowledge Silo Analysis
        ...
        Usage: 
          gitlock_holmes knowledge-silos [options]
        ...
        Example:
          gitlock_holmes knowledge-silos --repo ./my_project
      ...
      "couplings" ->
        IO.puts("""
        GitlockHolmes - Coupling Analysis
        ...
        Usage: 
          gitlock_holmes couplings [options]
        ...
        Example:
          gitlock_holmes couplings --repo ./my_project --min-coupling 20
      ...
      "coupled_hotspots" ->
        ...
        Example:
          gitlock_holmes coupled-hotspots --repo ./my_project --dir ./my_project
      ...
      "blast_radius" ->
        IO.puts("""
        GitlockHolmes - Blast Radius Analysis
        ...
        Usage: 
          gitlock_holmes blast-radius [options]
        ...
        Example:
          gitlock_holmes blast-radius --repo ./my_project --dir ./my_project --target-files lib/core.ex
      ...
      "summary" ->
        ...
        Example:
          gitlock_holmes summary --repo ./my_project
  ...
  # Displays the current version of GitlockHolmes.
  defp display_version do
    IO.puts("GitlockHolmes v#{@version}")
  end
  ...
  defp display_invalid_options(invalid) do
    ...
    IO.puts(:stderr, "Run 'gitlock_holmes --help' for usage information.")
    System.halt(1)
  end
  ...
  defp available_investigations_string do
    GitlockHolmesCore.available_investigations()
