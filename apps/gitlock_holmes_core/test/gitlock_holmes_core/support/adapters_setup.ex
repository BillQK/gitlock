defmodule GitlockHolmesCore.TestSupport.AdaptersSetup do
  @moduledoc """
  ...
  def register_real_adapters(adapter_keys) do
    registrations = [
      {:vcs, adapter_keys.vcs, GitlockHolmesCore.Adapters.VCS.Git},
      {:vcs, adapter_keys.git_vcs, GitlockHolmesCore.Adapters.VCS.Git},
      {:reporter, adapter_keys.csv_reporter, GitlockHolmesCore.Adapters.Reporters.CsvReporter},
      {:reporter, adapter_keys.json_reporter, GitlockHolmesCore.Adapters.Reporters.JsonReporter},
      {:complexity_analyzer, adapter_keys.complexity,
       GitlockHolmesCore.Adapters.Complexity.DispatchAnalyzer},
      {:file_system, adapter_keys.file_system,
       GitlockHolmesCore.Adapters.FileSystem.LocalFileSystem}
    ]
  ...
  defmacro setup_unique_adapters() do
    quote do
      alias GitlockHolmesCore.TestSupport.AdaptersSetup
      import Mox
