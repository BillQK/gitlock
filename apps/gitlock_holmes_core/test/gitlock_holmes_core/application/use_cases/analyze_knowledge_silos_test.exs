defmodule GitlockHolmesCore.Application.UseCases.AnalyzeKnowledgeSilosTest do
  ...
  alias GitlockHolmesCore.Mocks.{VersionControlMock, ReporterMock}
  alias GitlockHolmesCore.Application.UseCases.AnalyzeKnowledgeSilos
  alias GitlockHolmesCore.Domain.Entities.{Commit, Author}
  alias GitlockHolmesCore.Domain.Values.{FileChange, KnowledgeSilo}
