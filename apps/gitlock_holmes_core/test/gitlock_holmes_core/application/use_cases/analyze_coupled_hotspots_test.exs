defmodule GitlockHolmesCore.Application.UseCases.AnalyzeCoupledHotspotsTest do
  use ExUnit.Case, async: true

  import GitlockHolmesCore.TestSupport.AdaptersSetup, only: [setup_unique_adapters: 0]

  alias GitlockHolmesCore.Mocks.{VersionControlMock, ReporterMock, ComplexityAnalyzerMock}
  alias GitlockHolmesCore.Application.UseCases.AnalyzeCoupledHotspots
  alias GitlockHolmesCore.Domain.Entities.{Commit, Author}
  alias GitlockHolmesCore.Domain.Values.{FileChange, ComplexityMetrics, CombinedRisk}
