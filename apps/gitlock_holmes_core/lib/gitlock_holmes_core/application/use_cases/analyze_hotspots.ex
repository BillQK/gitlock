defmodule GitlockHolmesCore.Application.UseCases.AnalyzeHotspots do
  use GitlockHolmesCore.Application.UseCase

  alias GitlockHolmesCore.Domain.Services.{HotspotDetection, ComplexityCollector}
  ...
  defp resolve_complexity_analyzer(options) do
    if Map.has_key?(options, :dir) do
      ...
      {:error, "Directory path required for hotspot analysis"}
    end
  end
