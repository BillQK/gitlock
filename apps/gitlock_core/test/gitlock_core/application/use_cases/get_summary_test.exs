defmodule GitlockCore.Application.UseCases.GetSummaryTest do
  use ExUnit.Case, async: true

  import GitlockCore.TestSupport.AdaptersSetup, only: [setup_unique_adapters: 0]

  alias GitlockCore.Mocks.VersionControlMock
  alias GitlockCore.Mocks.ReporterMock

  alias GitlockCore.Application.UseCases.GetSummary
