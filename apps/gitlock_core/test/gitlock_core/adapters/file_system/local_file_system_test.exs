defmodule GitlockCore.Adapters.FileSystem.LocalFileSystemTest do
  ...
  test "implements FileSystemPort behavior" do
    ...
    assert GitlockCore.Ports.FileSystemPort in behaviors

    # Verify all callbacks are implemented
    port_callbacks = GitlockCore.Ports.FileSystemPort.behaviour_info(:callbacks)
