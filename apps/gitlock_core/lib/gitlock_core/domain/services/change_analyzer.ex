defmodule GitlockCore.Domain.Services.ChangeAnalyzer do
  @moduledoc """
  ...
  """
  alias GitlockCore.Domain.Services.ComponentImpactAnalysis
  alias GitlockCore.Domain.Values.ChangeImpact
  alias GitlockCore.Domain.Values.FileGraph
  alias GitlockCore.Domain.Services.ComputeCouplings
