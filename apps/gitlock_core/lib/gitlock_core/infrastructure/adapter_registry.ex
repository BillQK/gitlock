defmodule GitlockCore.Infrastructure.AdapterRegistry do
  @moduledoc """
  ...
  def init(_opts) do
    registry = %{
      vcs: %{
        "git" => GitlockCore.Adapters.VCS.Git
      },
      reporter: %{
      ...
      file_system: %{
        "local_file_system" => GitlockCore.Adapters.FileSystem.LocalFileSystem
      }
    }
