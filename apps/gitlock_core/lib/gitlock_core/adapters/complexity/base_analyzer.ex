defmodule GitlockCore.Adapters.Complexity.BaseAnalyzer do
  @moduledoc """
  ...
  ## Examples
      ...
      defmodule MyAnalyzer do
        use Gitlock.Adapters.Complexity.BaseAnalyzer
  ...
  defmacro __using__(opts) do
    quote do
      @behaviour GitlockCore.Ports.ComplexityAnalyzerPort

      alias GitlockCore.Domain.Values.ComplexityMetrics
      alias GitlockCore.Adapters.Complexity.BaseAnalyzer
      ...
      @file_system GitlockCore.Adapters.FileSystem.LocalFileSystem
