defmodule GitlockPhx.Accounts do
  @moduledoc """
  ...
  alias GitlockPhx.Accounts.{User, UserToken, UserNotifier}
  ...
  See `GitlockPhx.Accounts.User.email_changeset/3` for a list of supported options.
  ...
  See `GitlockPhx.Accounts.User.password_changeset/3` for a list of supported options.
